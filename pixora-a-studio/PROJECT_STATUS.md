...
боковое меню уезжает при выборе слоя, отключить,
закрывается только если нажать на тугл или на пустомэкране
при нажатии на пустой экран при открытой панели, срабатывает карандаш,
нужно запретить первый раз пир клики на холст

холст прижат к левому верхнему углу, нужно центрировать
